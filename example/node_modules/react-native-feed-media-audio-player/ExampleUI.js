      ...
      return (
        <View style={styles.container}>
          ...
          }} title="play"/>
          {
            ...
            this.state.requestingSkip ? (<Text style={styles.text}>(trying to skip)</Text>) : // eslint-disable-line indent
                                        (<Button onPress={() => { this.skip(); }} title="skip"/>) // eslint-disable-line indent
          }
        </View>
      );
    }
