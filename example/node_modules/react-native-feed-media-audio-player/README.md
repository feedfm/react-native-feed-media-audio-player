...
Check out [example/App.js](https://github.com/feedfm/react-native-feed-media-audio-player/blob/master/example/App.js)
for a minimal native React app that plays music using this library and displays
play/pause/skip controls along with the current song.
