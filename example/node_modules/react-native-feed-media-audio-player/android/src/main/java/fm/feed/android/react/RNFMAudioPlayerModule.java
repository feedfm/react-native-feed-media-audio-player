...
public class RNFMAudioPlayerModule extends ReactContextBaseJavaModule implements FeedAudioPlayer.StateListener, FeedAudioPlayer.StationChangedListener {
    ...
    FeedPlayerService.getInstance(new FeedAudioPlayer.AvailabilityListener() {
      ...
      public void onPlayerAvailable(FeedAudioPlayer feedAudioPlayer) {
        ...
        try {
          ...
          params.putString("activeStationId", mFeedAudioPlayer.getActiveStation().getId().toString());
        ...
        onStateChanged(mFeedAudioPlayer.getState());
        onStationChanged(mFeedAudioPlayer.getActiveStation());
      }
  ...
  public void onStationChanged(Station station) {
    ...
    WritableMap params = Arguments.createMap();
    params.putString("activeStationId", station.getId().toString());
