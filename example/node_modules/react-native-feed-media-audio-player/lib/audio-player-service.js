...
class AudioPlayerService {
    ...
    /**
     * Initialize player and kick off contact with feed.fm
     */
    ...
    /**
     * Event handler for 'availability' event.
     * 
    ...
    /**
     * Retrieve the AudioPlayer instance after it has been determined whether music
     * is available or not. This is really a convenience function that takes the place
     * of having to watch for the player to transition to a valid state and then
     * retrieve the list of available music stations.
     * 
